  ...
  return (
    <div className="mx-10">
      ...
      >
        ...
        >
          <div className="flex flex-col h-full mt-40 text-[#FFFFFF]">
            <div className="text-[80px] font-extrabold  px-20">
              Simplify Your <br /> Customs Brokerage <br /> Process with Us
            </div>
            <div className=" w-1/2 px-20 ">
              Welcome to our customs brokerage services. We specialize in <br />
              providing efficient and reliable solutions for all your customs
              needs.
              <br /> Whether you're importing or exporting goods, our team of
              experts <br /> will ensure a smooth and hassle-free process.
            </div>
          </div>
        </motion.div>
      </div>
        ...
        <div className="flex flex-col gap-8 pr-20 justify-center items-center pl-20  ">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-[20px]">
              ...
              committed to providing you with top-notch customs brokerage
        ...
        <div className="flex flex-col gap-8 pr-20 justify-center items-center pl-20  ">
          <div>
            ...
            <p className="text-[20px]">
              ...
              commitment to precision and streamlined operations positions us as
              your trusted partner for effortless solutions in the intricate
              world of international commerce. Trust Earthliner for customs
              brokerage that sets you apart.
            </p>
          </div>
      ...
      <section className="flex items-center flex-col my-20 gap-10">
